// Ported from obsidian-pm (MIT, StepanKropachev/obsidian-pm)
// src/views/gantt/TimelineConfig.ts — imports rewired to @pm/shared.
import type { Task, GanttGranularity } from '@pm/shared'
import { flattenTasks, Temporal, today, parsePlainDate } from '@pm/shared'
