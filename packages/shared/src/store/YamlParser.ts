// Ported from obsidian-pm (MIT, StepanKropachev/obsidian-pm). Obsidian's parseYaml
// is replaced by the `yaml` package, matching the reference repo's own test stub.
